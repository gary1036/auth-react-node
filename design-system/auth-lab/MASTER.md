...
|------|-----|--------------|
| Primary | `#52525B` | `--color-primary` |
| On Primary | `#FAFAFA` | `--color-on-primary` |
| Secondary | `#71717A` | `--color-secondary` |
| Accent/CTA | `#3F3F46` | `--color-accent` |
| Background | `#F4F4F5` | `--color-background` |
| Foreground | `#27272A` | `--color-foreground` |
| Muted | `#E4E4E7` | `--color-muted` |
| Border | `#D4D4D8` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| Ring | `#52525B` | `--color-ring` |

**Color Notes:** Soft zinc gray. Light canvas — avoid near-black backgrounds.

### Typography

- **Heading Font:** Plus Jakarta Sans
- **Body Font:** Plus Jakarta Sans
- **Mood:** Neutral, operational, calm hierarchy
